...
train_fileHeader = ["local_model", "flr", "average_loss", "accuracy", "correct_data",
                    "total_data"]
# train_fileHeader = ["local_model", "round", "epoch", "internal_epoch", "average_loss", "accuracy", "correct_data",
#                     "total_data"]
# test_fileHeader = ["model", "flr", "average_loss", "accuracy", "correct_data", "total_data"]
test_fileHeader = ["model", "flr", "avg_clean_loss", "avg_poison_loss", "avg_clean_acc", "avg_poison_acc"]
train_result = []  # train_fileHeader
test_result = []  # test_fileHeader
posiontest_result = []  # test_fileHeader

triggertest_fileHeader = ["model", "flr", "average_loss", "accuracy", "correct_data",
                          "total_data"]
